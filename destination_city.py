...
def destination_find():
 ...
 if curr_season in ["Fall"]:
  ...
  choice = vacation_cities["Spring"][random.randint(0, len(vacation_citie    s["Spring"]) -1)]
  print(f"Your next spring vacation destination is {choice}")
  
 elif curr_season == "Winter":
  choice = vacation_cities["Winter"][random.randint(0, len(vacation_citie    s["Winter"]) -1)]
  print(f"Your next winter vacation destination is {choice}")
 
 elif curr_season == "Summer":
  choice = vacation_cities["Summer"][random.randint(0, len(vacation_citie    s["Summer"]) -1)]
